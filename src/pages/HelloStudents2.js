...
export default function HelloStudents2() {
    return (
        ...
        <div style={{width: 300, height: 161, left: 200, top: 183, position: 'absolute'}}>
            ...
            <div style={{width: 230, left: 35, top: 38, position: 'absolute', color: 'black', fontSize: 30, fontFamily: 'Itim', fontWeight: '400', wordWrap: 'break-word'}}>Let’s learn about volcanoes!</div>
        </div>
        <img style={{width: 257, height: 305, left: 235, top: 344, position: 'absolute'}} src={earth} />
        <div style={{left: 430, top: 751, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 50, fontFamily: 'Itim', fontWeight: '400', wordWrap: 'break-word'}}>- Page 1: Welcome -</div>
