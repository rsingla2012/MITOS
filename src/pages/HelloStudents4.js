...
export default function HelloStudents4() {
    ...
    <div style={{width: 300, height: 161, left: 200, top: 183, position: 'absolute'}}>
        ...
        <div style={{width: 230, left: 35, top: 38, position: 'absolute', color: 'black', fontSize: 35, fontFamily: 'Itim', fontWeight: '400', wordWrap: 'break-word'}}>Nice work! Let’s move on.</div>
    </div>
